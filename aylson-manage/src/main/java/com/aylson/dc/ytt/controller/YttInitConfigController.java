...
import com.aylson.dc.ytt.vo.YttInitConfigVo;
 ...
 */
@Controller
@RequestMapping("/ytt/initConfig")
public class YttInitConfigController extends BaseController {
	
	protected static final Logger logger = Logger.getLogger(YttInitConfigController.class);

	@Autowired
	private YttInitConfigService initConfigService;
	...
	public String toIndex() {
		return "/jsp/ytt/admin/initConfig/index";
	}
	...
	@ResponseBody
	public EasyuiDataGridJson list(YttInitConfigSearch initConfigSearch){
		EasyuiDataGridJson result = new EasyuiDataGridJson();//页面DataGrid结果集
		try{
			initConfigSearch.setIsPage(true);
			List<YttInitConfigVo> list = this.initConfigService.getList(initConfigSearch);
	...
	public String toAdd(YttInitConfigVo initConfigVo) {
		this.request.setAttribute("initConfigVo", initConfigVo);
		return "/jsp/ytt/admin/initConfig/add";
	}
	...
	@ResponseBody
	public Result add(YttInitConfigVo initConfigVo) {
	...
	public String toEdit(String id) {
		if(id != null){
			YttInitConfigVo initConfigVo = this.initConfigService.getById(id);
			this.request.setAttribute("initConfigVo", initConfigVo);
		}
		return "/jsp/ytt/admin/initConfig/add";
	}
	...
	@ResponseBody
	public Result update(YttInitConfigVo initConfigVo) {
		Result result = new Result();
		try {
			SessionInfo sessionInfo = (SessionInfo)this.request.getSession().getAttribute("sessionInfo");
