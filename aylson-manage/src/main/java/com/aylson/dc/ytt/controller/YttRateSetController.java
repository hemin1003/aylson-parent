...
import com.aylson.dc.ytt.vo.YttRateSetVo;
 ...
 */
@Controller
@RequestMapping("/ytt/rateSet")
public class YttRateSetController extends BaseController {
	
	protected static final Logger logger = Logger.getLogger(YttRateSetController.class);

	@Autowired
	private YttRateSetService rateSetService;
	...
	public String toIndex() {
		return "/jsp/ytt/admin/rateSet/index";
	}
	...
	@ResponseBody
	public EasyuiDataGridJson list(YttRateSetSearch rateSetSearch){
		EasyuiDataGridJson result = new EasyuiDataGridJson();//页面DataGrid结果集
		try{
			rateSetSearch.setIsPage(true);
			List<YttRateSetVo> list = this.rateSetService.getList(rateSetSearch);
	...
	public String toAdd(YttRateSetVo rateSetVo) {
		this.request.setAttribute("rateSetVo", rateSetVo);
		return "/jsp/ytt/admin/rateSet/add";
	}
	...
	@ResponseBody
	public Result add(YttRateSetVo rateSetVo) {
	...
	public String toEdit(String id) {
		if(id != null){
			YttRateSetVo rateSetVo = this.rateSetService.getById(id);
			this.request.setAttribute("rateSetVo", rateSetVo);
		}
		return "/jsp/ytt/admin/rateSet/add";
	}
	...
	@ResponseBody
	public Result update(YttRateSetVo rateSetVo) {
		Result result = new Result();
		try {
			SessionInfo sessionInfo = (SessionInfo)this.request.getSession().getAttribute("sessionInfo");
	...
	@ResponseBody
	public Result changeStatus(YttRateSetVo rateSetVo) {
		Result result = new Result();
		try {
